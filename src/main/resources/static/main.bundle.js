...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__authentication_registration_registration_component__ = __webpack_require__("../../../../../src/app/authentication/registration/registration.component.ts");
...
var routes = [
    {
        path: 'register',
        component: __WEBPACK_IMPORTED_MODULE_2__authentication_registration_registration_component__["a" /* RegistrationComponent */],
    },
    {
        path: 'login',
        component: __WEBPACK_IMPORTED_MODULE_3__authentication_login_login_component__["a" /* LoginComponent */],
    },
    {
        path: '',
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["M" /* NgModule */])({
        ...
        imports: [
            __WEBPACK_IMPORTED_MODULE_0__angular_platform_browser__["a" /* BrowserModule */], __WEBPACK_IMPORTED_MODULE_3__authentication_authentication_module__["a" /* AuthenticationModule */], __WEBPACK_IMPORTED_MODULE_4__app_routing_module__["a" /* AppRoutingModule */], __WEBPACK_IMPORTED_MODULE_6__ng_bootstrap_ng_bootstrap__["a" /* NgbModule */].forRoot(), __WEBPACK_IMPORTED_MODULE_5__angular_forms__["b" /* FormsModule */], __WEBPACK_IMPORTED_MODULE_5__angular_forms__["e" /* ReactiveFormsModule */]
        ],
        providers: [],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__authentication_component__ = __webpack_require__("../../../../../src/app/authentication/authentication.component.ts");
...
AuthenticationModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["M" /* NgModule */])({
        imports: [
            __WEBPACK_IMPORTED_MODULE_1__angular_common__["b" /* CommonModule */], __WEBPACK_IMPORTED_MODULE_7__ng_bootstrap_ng_bootstrap__["a" /* NgbModule */], __WEBPACK_IMPORTED_MODULE_6__angular_forms__["b" /* FormsModule */], __WEBPACK_IMPORTED_MODULE_6__angular_forms__["e" /* ReactiveFormsModule */], __WEBPACK_IMPORTED_MODULE_5__angular_http__["c" /* HttpModule */]
        ],
        declarations: [__WEBPACK_IMPORTED_MODULE_2__login_login_component__["a" /* LoginComponent */], __WEBPACK_IMPORTED_MODULE_3__registration_registration_component__["a" /* RegistrationComponent */], __WEBPACK_IMPORTED_MODULE_4__authentication_component__["a" /* AuthenticationComponent */]],
        exports: [__WEBPACK_IMPORTED_MODULE_4__authentication_component__["a" /* AuthenticationComponent */]],
        providers: []
    })
...
var AuthenticationService = (function () {
    ...
    AuthenticationService.prototype.authenticate = function (value) {
        var bodyString = JSON.stringify(value.userId);
...
module.exports = "<br><br>\n<h3 class=\"center\">Login</h3>\n<span class=\"col-md-3\"></span>\n<form [formGroup]=\"loginForm\" class=\"col-md-6 border\" (ngSubmit)=\"authenticate(loginForm)\">\n  <div class=\"form-group\">\n    <label>UserId</label>\n    <input type=\"email\" class=\"form-control\" [formControl]=\"loginForm.controls['userId']\" id=\"email\" placeholder=\"Email\" email>\n  </div>\n  <div class=\"form-group\">\n    <label>Password</label>\n    <input type=\"password\" class=\"form-control\" [formControl]=\"loginForm.controls['password']\" id=\"password\" placeholder=\"Password\">\n  </div>\n  <div class=\"center\">\n    <button type=\"submit\" class=\"btn btn-danger\"  [disabled]=\"!loginForm.valid\">Login</button>\n  </div>\n\n</form>\n"
...
var LoginComponent = (function () {
    function LoginComponent(fb, authenticationService) {
    ...
    LoginComponent.prototype.authenticate = function (form) {
        ...
        this.authenticationService.authenticate(form.value).subscribe(function (response) {
            if (response === true) {
